...
public class OfferChannel extends Thread {
        ...
        for (Offer first : this.offers) {
            ...
            for (Offer second : this.offers) {
                ...
                if (isViable(first,second)) {
                    Transaction t = new Transaction(first.getMinReceive(),first.getCommodity1(),
                            second.getMinReceive(),first.getCommodity2(), first.getSender());
                    Transaction q =  new Transaction(second.getMinReceive(),second.getCommodity1(),
                            first.getMinReceive(),second.getCommodity2(), second.getSender());
     ...
     *3. They trade at a rate of rate
    ...
    public boolean isViable(Offer first, Offer second){
        ...
        if (first.getCommodity1().name().equals(second.getCommodity2().name())
